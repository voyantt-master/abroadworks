...
$(document).ready(function(){
 ...
 $(".brands").owlCarousel({
  ...
  responsive: {
    0: {
      items: 3 // 3 item between 0 and the next breakpoint
...
$(document).ready(function(){
  ...
  function updateClasses(){
    // Reset all styles
    $('#carousel-client .owl-item').removeClass('big-slide small-slide');

    // Apply styles
    $('#carousel-client .owl-item.active.center').addClass('big-slide');
    $('#carousel-client .owl-item.active').not('.center').addClass('small-slide');
  }

  // Initial class update
  updateClasses();
  
  // Listen for translation and update classes
